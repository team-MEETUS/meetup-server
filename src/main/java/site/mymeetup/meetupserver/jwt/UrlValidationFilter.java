...
public class UrlValidationFilter extends OncePerRequestFilter {
    ...
    private final List<String> validUrls = Arrays.asList(
            ...
            "/api/v1/crews/interests", "/api/v1/crews/new", "/api/v1/crews/search",
            ...
            "/api/v1/members/oauth2", "/api/v1/login", "/api/v1/members/login/oauth2/code/.*", "/api/v1/members/[0-9]+", "/api/v1/members/join", "/api/v1/members/phoneCheck", "/login"
    );
